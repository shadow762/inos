...
?>
    ...
    <ul class="w800 m0auto mt-10 fs18 ul-2 txt-vi2 tsd">
        <li class="">
            <span class="mr-10 fin fs25 fb">&#10004;</span>
    ...
    <h4 id="id-math" class="h4-page-header fb mt-50 tsd">ОБРАЗЕЦ УДОСТОВЕРЕНИЯ</h4>
    <h4 class="h4-page-header fb tsd">О ПОВЫШЕНИИ КВАЛИФИКАЦИИ</h4>
    <h4 class="h4-page-header fb tsd">ПО МАТЕМАТИКЕ</h4>
    ...
    <img src="<?php echo get_template_directory_uri()?>/img/udostov/inos1.png" alt="фото" class="w600 m0auto d-block mtb-20">
