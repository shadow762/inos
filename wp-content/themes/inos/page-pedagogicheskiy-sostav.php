...
<div class="ruk-center-block clearfix">
    ...
    <div class="table1 clearfix w800">
        <div class="table1-cell cell-w10">
            <p>ФИО РАБОТНИКА</p>
        </div>
        <div class="table1-cell cell-w50">
            <p>МЕСТО РАБОТЫ</p>
        </div>
        <div class="table1-cell cell-w50">
            <p>ЗАНИМАЕМАЯ ДОЛЖНОСТЬ /
                ДОЛЖНОСТИ/
                ВИД ЗАНЯТОСТИ / УСЛОВИЯ ПРИВЛЕЧЕНИЯ К РАБОТЕ (ШТАТНЫЙ, СОВМЕСТИТЕЛЬ, ИНОЕ)
            </p>
        </div>
        <div class="table1-cell cell-w50">
            <p>ФКАКОЕ ОБРАЗОВАТЕЛЬНОЕ УЧРЕЖДЕНИЕ ПРОФЕССИОНАЛЬНОГО ОБРАЗОВАНИЯ ОКОНЧИЛ /СПЕЦИАЛИТЕТ (СПЕЦИАЛЬНОСТЬ ПО ДИПЛОМУ)</p>
        </div>
        <div class="table1-cell cell-w50">
            <p>АСПИРАНТУРА/
                ДОКТОРАНТУРА
        ...
        <div class="table1-cell">
            <p>НАИМЕНОВАНИЕ НАПРАВЛЕНИЯ ПОДГОТОВКИ И (ИЛИ) СПЕЦИАЛЬНОСТИ
            </p>
        </div>
        <div class="table1-cell">
    ...
    <div class="table2">
        <p>СОКОЛОВА ГАЛИНА КОНСТАНТИНОВНА</p>
    </div>
    ...
    <div class="tbl">
        <div class="tc cell-w20"><p>
                МЕСТО РАБОТЫ
            </p></div>
        <div class="tc">МЕСТО РАБОТЫ</div>
        <div class="tc">МЕСТО РАБОТЫ</div>
        <div class="tc">МЕСТО РАБОТЫ</div>
    </div>
