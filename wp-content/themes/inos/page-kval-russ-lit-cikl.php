...
?>
    ...
    <p class="w800 m0auto  fs20 fi txt-vi2 tsd">
         <img src="<?php echo get_template_directory_uri()?>/img/pero.png" alt="" class="w50h60">
        <b>Федеральные государственные образовательные стандарты общего образования</b> в системе нормативно-правового и методического обеспечения.
    </p>

    <p class="w800 m0auto fi  fs20 txt-vi2 tsd">
         <img src="<?php echo get_template_directory_uri()?>/img/pero.png" alt="" class="w50h60">
        <b>Требования к образовательным результатам</b> предметной области русский язык и литература.
    </p>

    <p class="w800 m0auto fi fs20 txt-vi2 tsd">
         <img src="<?php echo get_template_directory_uri()?>/img/pero.png" alt="" class="w50h60">
        Нормативно-законодательная и методическая <b>основа проектной деятельности.</b>
    </p>
    ...
    <ul class="w800 m0auto mt-10 fs18 fi ul-2 txt-vi2 tsd">
        <li class="">
            <img src="<?php echo get_template_directory_uri()?>/img/icons/sand-clock.svg" alt="" class="w20h20 mr-10">
            <b>Отбор значимых</b> для учителя русского языка <b>Интернет-ресурсов.</b>
        </li>
        <li class="">
            <img src="<?php echo get_template_directory_uri()?>/img/icons/sand-clock.svg" alt="" class="w20h20 mr-10">
            <b>Приемы и методы работы с Интернет-ресурсами</b> на уроках русского языка.
        </li>
        <li class="">
            <img src="<?php echo get_template_directory_uri()?>/img/icons/sand-clock.svg" alt="" class="w20h20 mr-10">
            <b>Значение Интернет-ресурсов при формировании метапредметных</b> (в т. ч. информационных) умений у обучающихся 5-9 классов в процессе обучения русскому языку.
        </li>
        <li class="">
            <img src="<?php echo get_template_directory_uri()?>/img/icons/sand-clock.svg" alt="" class="w20h20 mr-10">
            <b>Отбор контента</b> для уроков русского языка.
        </li>
        <li class="fb">
            <img src="<?php echo get_template_directory_uri()?>/img/icons/sand-clock.svg" alt="" class="w20h20 mr-10">
    ...
    <ul class="w800 m0auto mt-10 fs18 fi ul-2 txt-vi2 tsd">
        <li class="">
            <img src="<?php echo get_template_directory_uri()?>/img/icons/sand-clock.svg" alt="" class="w20h20 mr-10">
            Уроки русского языка с использованием фото-, аудио-, <b>видеоинформации.</b>
        </li>
        <li class="fb">
            <img src="<?php echo get_template_directory_uri()?>/img/icons/sand-clock.svg" alt="" class="w20h20 mr-10">
    ...
    <ul class="w800 m0auto mt-10 fs18 fi ul-2 txt-vi2 tsd">
        ...
        <li class="">
            ...
            приводят к заметному падению <b>речевой грамотности.</b>
        </li>
    </ul>

    <p class="w800 m0auto fi   fs20 txt-vi2 tsd">
         <img src="<?php echo get_template_directory_uri()?>/img/pero.png" alt="" class="w50h60">
        Методика формирования у учащихся <b>ответственного и осознанного отношения</b> к использованию русского языка во всех сферах жизни, повышение <b>речевой культуры.</b>
    </p>
    ...
    <ul class="w800 m0auto mt-10 fi fs20 ul-2 txt-vi2 tsd">
        <li class="">
            <img src="<?php echo get_template_directory_uri()?>/img/icons/sand-clock.svg" alt="" class="w20h20 mr-10">
    ...
    <p class="w800 m0auto   fs20 fi txt-vi2 tsd">
         <img src="<?php echo get_template_directory_uri()?>/img/pero.png" alt="" class="w50h60">
        Специфика целей и содержания работы по формированию <b>читательской грамотности</b> на уроках русского языка в основной школе.
    </p>

    <p class="w800 m0auto fi  fs20 txt-vi2 tsd">
         <img src="<?php echo get_template_directory_uri()?>/img/pero.png" alt="" class="w50h60">
        Читательская грамотность как компонент функциональной грамотности подростка и как <b>важнейший планируемый результат обучения</b> русскому языку в основной школе.
    </p>
    ...
    <p class="w800 m0auto fi  fs20 txt-vi2 tsd">
         <img src="<?php echo get_template_directory_uri()?>/img/pero.png" alt="" class="w50h60">
        <b>Формирование читательской грамотности</b> (способности к поиску, пониманию и интерпретации информации текста, к определению коммуникативной установки устного и письменного сообщения, его темы, основной мысли, основной и дополнительной информации).
    </p>

    <p class="w800 m0auto fi   fs20 txt-vi2 tsd">
         <img src="<?php echo get_template_directory_uri()?>/img/pero.png" alt="" class="w50h60">
        Формирование читательской грамотности в процессе работы над <b>различными видами чтения</b> в основной школе.
    </p>
    <ul class="w800 m0auto mt-10 fs18 fi ul-2 txt-vi2 tsd">
        <li class="">
            <img src="<?php echo get_template_directory_uri()?>/img/icons/sand-clock.svg" alt="" class="w20h20 mr-10">
    ...
    <p class="w800 m0auto fi  fs20 txt-vi2 tsd">
         <img src="<?php echo get_template_directory_uri()?>/img/pero.png" alt="" class="w50h60">
        <b>Оценивание метапредметных умений</b> школьника при работе с учебным текстом.
    </p>

    <p class="w800 m0auto fi  fs20 txt-vi2 tsd">
         <img src="<?php echo get_template_directory_uri()?>/img/pero.png" alt="" class="w50h60">
        <b>Примеры комплексных работ для оценивания</b> метапредметных умений школьника при работе с учебным текстом.
    </p>
    ...
    <p class="w800 m0auto fi  fs18 txt-vi2 tsd">
         <img src="<?php echo get_template_directory_uri()?>/img/pero.png" alt="" class="w50h60">
